 ...
 * @author ambor
 */
public class RelativePos implements Comparable<RelativePos> {
	private Point chunkPoint;
	private Point3D tilePoint;
	private static Generator generator;
	private static Generator zero = new Generator(1,1,1,1,1);
	 ...
	 */
	public int compareTo(RelativePos testRelative) { // returns the value of testRelative in relation to this
	...
	public static Point3D correctOutOfBounds(Point3D pos) {
		...
		if (generator.compareTo(toRel(pos)) == 1) { // Correcting for greater than bounds positions
		...
		} else if (generator.compareTo(toRel(pos)) == -2) { // Correcting for less than bounds positions (-1,-1)
	 ...
	 * @param zShift
	 * 			How much to shift on the z axis
	 */
